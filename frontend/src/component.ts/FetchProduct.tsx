...
// import intaface from '../idl/bookeeper.json'

const CENTRAL_PDA = '8KM547yjooFoaUNphj4tHyADkN76Mj8LSPw91P9wV3fV';
...
const idl: anchor.Idl = {
  ...
  instructions: [
    ...
    {
      name: "saveTrade",
      accounts: [{ name: "baseAccount", isMut: true, isSigner: false }],
      args: [
  ...
  accounts: [
    {
      ...
      type: {
        kind: "struct",
        fields: [{ name: "trades", type: { vec: { defined: "Trade" } } }],
      },
    },
  ],
  types: [
  ...
  errors: [{ code: 6000, name: "NoTrades", msg: "No Trade has Occured." }],
};
    ...
    try {
      ...
      if (accountData.trades) {
        setTrades((prevTrades) => [
          ...prevTrades, // Keep existing trades
